...
print("\n Model & Scaler saved locally!")


#  Predict for a new sample input (must match all 23 features)
sample_input = pd.DataFrame([[
    ...
    0,      # Competitor
    50,     # Orders
    10,     # Promised Time (min)
    12,     # Actual Time (min)
    1,      # Delivered On Time
    0,      # Early By (min)
    2,      # Delay By (min)
    20,     # Timing Deviation Cost

    1, 0, 0,    # Company (JioMart, Swiggy, Zepto)
    0, 1,       # Traffic Level (Low, Medium)
    1, 0,       # Order Type (Food, Grocery)
    1           # Area Type (Urban)
...
print(f"\n Predicted Agents Needed for New Input: {round(predicted_agents[0])}")
